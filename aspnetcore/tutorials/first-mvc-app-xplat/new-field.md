...
<span data-ttu-id="5a7f9-104">[이전 - 검색 추가](search.md)
[다음 - 유효성 검사 추가](validation.md)</span><span class="sxs-lookup"><span data-stu-id="5a7f9-104">[Previous - Add search](search.md)
