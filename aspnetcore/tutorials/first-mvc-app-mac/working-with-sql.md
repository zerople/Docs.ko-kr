...
<span data-ttu-id="9af19-104">[이전 - 모델 추가](adding-model.md)
[다음 - 컨트롤러 메서드 및 보기](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="9af19-104">[Previous - Add a model](adding-model.md)
