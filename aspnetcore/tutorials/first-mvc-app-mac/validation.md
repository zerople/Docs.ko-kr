...
<span data-ttu-id="c96c4-104">[이전 - 필드 추가](new-field.md)
[다음 - 세부 정보 및 삭제 메서드 검사](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="c96c4-104">[Previous - Add a field](new-field.md)
