<span data-ttu-id="b8aba-101">`Movie` 클래스에 다음 속성을 추가합니다.</span><span class="sxs-lookup"><span data-stu-id="b8aba-101">Add the following properties to the `Movie` class:</span></span>
