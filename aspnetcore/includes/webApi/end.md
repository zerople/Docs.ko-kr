## <a name="implement-the-other-crud-operations"></a><span data-ttu-id="25117-101">기타 CRUD 작업 구현</span><span class="sxs-lookup"><span data-stu-id="25117-101">Implement the other CRUD operations</span></span>
